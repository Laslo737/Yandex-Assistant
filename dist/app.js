...
function createApp() {
    ...
    const workdayService = new workday_service_1.WorkdayService(trackerApiClient);
    const managerSummaryService = new manager_summary_service_1.ManagerSummaryService(trackerApiClient);
