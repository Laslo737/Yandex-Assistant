...
exports.env = {
    ...
    app: {
        ...
        publicBaseUrl: get('APP_PUBLIC_BASE_URL', get('PUBLIC_BASE_URL', `http://localhost:${get('PORT', '3000')}`))
    },
    yandexMessenger: {
    ...
    tracker: {
        ...
        apiBaseUrl: get('YANDEX_TRACKER_API_BASE_URL', 'https://api.tracker.yandex.net'),
        webBaseUrl: get('YANDEX_TRACKER_WEB_BASE_URL', 'https://tracker.yandex.ru'),
